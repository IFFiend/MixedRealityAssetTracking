...
public sealed class ONNXModel
{
    ...
    private readonly float[] Anchors = new float[] { 0.573f, 0.677f, 1.87f, 2.06f, 3.34f, 5.47f, 7.88f, 3.53f, 9.77f, 9.17f };
    private readonly int maxDetections = 20;
    private readonly float probabilityThreshold = 0.1f;
    private readonly IList<string> labels = new string[] {"vending machine"};
    ...
    {
        var extractedBoxes = this.ExtractBoxes(predictionOutputs, this.Anchors);
